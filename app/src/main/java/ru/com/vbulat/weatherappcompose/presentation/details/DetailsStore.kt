...
import ru.com.vbulat.weatherappcompose.domain.usecase.ChangeFavouriteStateUseCase
import ru.com.vbulat.weatherappcompose.domain.usecase.GetForecastUseCase
import ru.com.vbulat.weatherappcompose.domain.usecase.ObserveFavouriteStateUseCase
import ru.com.vbulat.weatherappcompose.presentation.details.DetailsStore.Intent
import ru.com.vbulat.weatherappcompose.presentation.details.DetailsStore.Label
import ru.com.vbulat.weatherappcompose.presentation.details.DetailsStore.State
...
internal class DetailsStoreFactory @Inject constructor(
    ...
    private sealed interface Action {
        ...
        data object ForecastLoadingEror : Action
    }
        ...
        override fun invoke() {
            ...
            scope.launch {
                ...
                try {
                    ...
                    dispatch(Action.ForecastLoadingEror)
                }
            }
        }
    }
