...
import ru.com.vbulat.weatherappcompose.presentation.ui.theme.Gradient
import ru.com.vbulat.weatherappcompose.presentation.ui.theme.Orange
    ...
    LazyVerticalGrid(
        ...
        itemsIndexed(
            ...
            CityCard(
                cityItem = cityItem,
                index = index,
                onClick = {component.onCityItemClick(cityItem.city)}
            )
        }
        item {
...
private fun CityCard(
    ...
    val gradient = gerGradientByIndex(index)
...
private fun gerGradientByIndex(index : Int) : Gradient {
